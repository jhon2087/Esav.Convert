...
<table style="height: 230px;">
 ...
 <tr>
    ...
    <td  >
        <asp:TextBox ID="txtUserName" onKeyPress="return onlyNumbersOrLetters(event);Verifica(event);" runat="server" class="email"
            oncontextmenu="return false" onpaste="return false" TabIndex="1" MaxLength="15" style="color: #16214D;" placeholder="Usuario"/>
 ...
 <tr>
    <td align="right" class="style3">
      <br />
        &nbsp;</td>
    <td >
        <asp:TextBox ID="txtPassword" onKeyPress="Verifica(event);" runat="server" class="password"
            TextMode="Password" TabIndex="2" MaxLength="15" style="color: #16214D;"
 ...
 <tr>
    ...
    <td colspan="2" align="left">
        <asp:Button Text="Ingresar" ID="btnLogin"  
            class="btnak" Width="145px" 
