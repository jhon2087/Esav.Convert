<%@ Page Title="" Language="C#" MasterPageFile="~/FormDocuments/MainConvert.master" AutoEventWireup="true" CodeFile="FrmEspecializado.aspx.cs" Inherits="FormDocuments_InterfaceContable_FrmEspecializado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpCuponeraBody" Runat="Server">
    ...
    <div class="body">
        ...
        <asp:Literal ID="Literal3" runat="server" Text=" DOCUMENTOS EMITIDOS FORMATO CONTABLE"></asp:Literal>
    </p>
    <br/><br/>
                ...
                <tr>
                    ...
                    <td colspan="2" style=" height: 44px;  width: 17px;">
                    ...
                    <td> 
                        ...
                        <select id="ddltipodocumento" name="ddltipodocumento" runat="server">
                            ...
                            <option value="03">NOTA DE REDITO</option>
                            <option value="04">NOTA DE DEBITO</option>
                             <option value="05">Billete Aéreo</option>
                            <option value="06">DOCUMENTOS EMITIDOS</option>
                            <option value="07">ADM</option>
                            <option value="08">ACM</option>
                            <option value="09">EMD</option>
                            <option value="10">Reembolsos</option>
                ...
                <tr>
                    ...
                    <td style="padding-top:5px;" colspan="2" align="left">
                        ...
                        <input type="button" id="btnSalir" runat="server"  class="aspRubenSalir"  onclick="return btnSalir_onclick()"
        ...
        <ItemTemplate>
                ...
                <tr  class="dataItemRow">
                        ...
                        <td class="dataItem" align="center"><%# WebHelper.getFechaFormatoNormal(Eval("FechaEmision")) %></td>
