<%@ Page Title="" Language="C#" MasterPageFile="~/FormDocuments/MainConvert.master" AutoEventWireup="true" CodeFile="FrmReporteConsolidado.aspx.cs" Inherits="FormDocuments_Reportes_FrmReporteConsolidado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpCuponeraBody" Runat="Server">
    ...
    <option value="5">Documento de Cobranza</option>
      ...
      <div id ="divGridCarrito1" align="center">
        <asp:Repeater runat="server" ID="rptListado1" 
              onitemdatabound="rptListado1_ItemDataBound" 
              onitemcommand="rptListado1_ItemCommand">
        <HeaderTemplate>
            <table class="gridContainer"  width="100%">
                <tr  >                    
                   ...
                   <th class="headerGlass" width="5%"><b><asp:Literal runat="server" id="Literal4" Text="<%$Resources:Label, lblSucursal %>"></asp:Literal></b></th>
                    <th class="headerGlass" width="5%"><b><asp:Literal runat="server" id="Literal3" Text="<%$Resources:Label, lblSerie %>"></asp:Literal></b></th>
                     <th class="headerGlass" width="5%"><b><asp:Literal runat="server" id="Literal1" Text="<%$Resources:Label, lblTipoDocumento %>"></asp:Literal></b></th>
      <%--               <th class="headerGlass" width="40%"><b><asp:Literal runat="server" id="Literal6" Text="<%$Resources:Label, lblRazonSocial %>"></asp:Literal></b></th>      
                     ...
                     <th class="headerGlass" width="5%"><b><asp:Literal runat="server" id="Literal5" Text="<%$Resources:Label, lblImporteTotal %>"></asp:Literal></b></th>        
<%--                     <th class="headerGlass" width="5%"><b><asp:Literal runat="server" id="Literal8" Text="---"></asp:Literal></b></th>      
   ...
   <script type="text/javascript">
       ...
       function goPage(idx) {
           ...
           DoCallBack("cargarGrillasConsolidado", RazonSocial + ':' + NroDocumento + ":" + Serie + ":" + idx + ":" + fechini + ":" + fechfin + ":" + tipodoc, End_goPage);
       ...
       function End_goPage(_arg) {
           ...
           document.getElementById("divGridCarrito1").innerHTML = mData[1];
       ...
       function btnBuscar_onclick() {
           ...
           DoCallBack("cargarGrillasConsolidado", RazonSocial + ':' + NroDocumento + ":" + Serie + ":" + "1" + ":" + fechini + ":" + fechfin + ":" + tipodoc, End_Buscar2);

       }
       function End_Buscar2(_arg) {
           var mData = _arg.split(":::");
           if (mData[0] == "-1") {
               alert(mData[1]);
               return;
