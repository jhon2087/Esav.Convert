<%@ Page Title="" Language="C#" MasterPageFile="~/FormDocuments/MainConvert.master" AutoEventWireup="true" CodeFile="FrmDocumentoCobranza.aspx.cs" Inherits="FormDocuments_ConsultaDocumentos_FrmDocumentoCobranza" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpCuponeraBody" Runat="Server">
 <div class="body">
        ...
        <asp:Literal ID="Literal3" runat="server" Text=" DOCUMENTOS DE COBRANZA"></asp:Literal>
    </p>
    <br/>
                <table width="100%" cellspacing="5" border="0">
               
                <tr>
                 <td align="right" style="  width: 92px;     height: 44px;" colspan="3">
                       &nbsp;
                    </td>
                    ...
                    <td align="left" style="  height: 44px;">&nbsp;</td>
                </tr>
                <tr>
                    <td style="padding-top:5px; width: 192px;"></td>
    ...
    <script type="text/javascript">
        ...
        function goPage(idx) {
            ...
            DoCallBack("cargarGrillas", fecha + ':' + fechaFinal + ':' + idx, End_goPage);
        ...
        function btnBuscar_onclick() {
            ...
            DoCallBack("cargarGrillas", fecha + ':' + fechaFinal + ':' + 1, End_Buscar);
